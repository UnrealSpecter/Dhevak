...
<head>
	...
	<!-- Scripts -->
	<script src="{{ asset('/js/analoge-websites/jquery-3.1.1.min.js') }}"></script>
	<script src="{{ asset('/js/analoge-websites/jquery.fullPage.js') }}"></script>
	<script src="{{ asset('/js/analoge-websites/scripts.js') }}"></script>
  <script src="{{ asset('/js/analoge-websites/analythics-script.js') }}"></script>
	...
	<div id="fullpage">
		...
		<div class="section active">
			<video class="binnenkomer-video" id='binnenkomer' autoplay loop>
				<source data-src="{{ asset('/videos/analoge-websites/binnenkomer-video.mp4') }}" type="video/mp4">
		...
		<div class="section">
			<video class="werkwijze-video" id='werkwijze'>
				<source data-src="{{ asset('/videos/analoge-websites/werkwijze-video.mp4') }}" type="video/mp4">
				Your browser does not support HTML5 video.
			</video>
		...
		<div class="section">
			<div class='fullpage-container'>
		      <img class="foto-portret frank-portret" src="{{ asset('/images/analoge-websites/frank-portret.jpg') }}" alt="Frank Portret">
		      <img class="foto-portret frank-foto" src="{{ asset('/images/analoge-websites/frank-foto.jpg') }}" alt="Frank Foto">
			</div>
		</div>
		<div class="section">
			<div class='fullpage-container'>
			    <img class="foto-portret tomi-portret" data-src="{{ asset('/images/analoge-websites/tomi-portret.jpg') }}" alt="Tomi Portret">
			    <img class="foto-portret tomi-foto" data-src="{{ asset('/images/analoge-websites/tomi-foto.jpg') }}" alt="Tomi Foto">
			</div>
		</div>
		<div class="section">
			<div class='fullpage-container'>
		      <img class="foto-portret amber-portret" data-src="{{ asset('/images/analoge-websites/amber-portret.jpg') }}" alt="Amber Portret">
		      <img class="foto-portret amber-foto" data-src="{{ asset('/images/analoge-websites/amber-foto.jpg') }}" alt="Amber Foto">
			</div>
		</div>
		<!-- contact -->
