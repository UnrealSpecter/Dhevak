...
<html lang="{{ app()->getLocale() }}">
    ...
    <div style="height: 100vh; width: 100vw;" data-enhance="false" data-role="page">
        ...
        <img class="building" src="{{ asset('/images/promotion/peter-van-dijk/building.png') }}" alt="peter-van-dijk-big-building">
        ...
        <div class="crane-container">
            ...
            <img class="cables" src="{{ asset('/images/promotion/peter-van-dijk/cables.png') }}" alt="peter-van-dijk-crane-cables">
        </div>
    </div>
