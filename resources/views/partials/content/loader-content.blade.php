...
<div class="loader-wrapper flex col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="loader-content flex flow-c col-lg-11 col-md-11 col-sm-11 col-xs-11">
        <h1 class="loader-title flex animated fadeIn">Dhèvak</h1>
        <div class="quote-wrapper animated fadeInUp" style="min-height: 10%;">
            ...
            <div class="loader-text quotes"><span style="font-style: italic; font-weight: bold;">*intense computational noises*</span></div>
            <div class="loader-text quotes">Hi. My name is Sara</div>
            <div class="loader-text quotes">Oh wacht dit is een nederlandse website... Hallo.</div>
            <div class="loader-text quotes">Het wachten is zo voorbij</div>
            <div class="loader-text quotes">Misschien ook niet</div>
            ...
            <div class="loader-text quotes">Zijn we hier nou nog bezig?</div>
            <div class="loader-text quotes">Uhm dat waren ze zo ongeveer...</div>
